      ...
      <div className="flex flex-col items-center justify-center lg:justify-between space-y-8 lg:space-y-0 ">
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="flex-1 max-w-md lg:max-w-xl lg:text-center space-y-3 md:space-y-6">
            <h1 className="font-bold text-center text-xl md:text-4xl">
              Oops! Page not found.
            </h1>
            ...
            <Link href="/">
              <div className="py-1">
                <p className="bg-blue-500 text-center hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-md">
                  Take me back Home
                </p>
              </div>
            </Link>
